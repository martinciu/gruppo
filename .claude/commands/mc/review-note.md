---
description: Distill brainstorm context into a one-page review-focus note for a future reviewer in a fresh session
---

Write a one-page "review focus" note to `.superpowers/review-notes/$ARGUMENTS.md`.

Audience: a fresh session (default model) that will review the PR for this plan. It
